 ...
 */
public class AddAptFragment extends Fragment implements DatePickerDialog.OnDateSetListener {

    private static final String TAG = AddAptFragment.class.getSimpleName();
    ...
    int ageMin = 20;
    int ageMax = 60;
    OnApartmentAddedListener onApartmentAddedListener;
    private EditText duration;
    private EditText movin;
    private EditText placeType;
    private String[] durationList,placeTypeList;
    private TextView rooms,vacancy;
    private CheckedTextView genderM,genderF,genderA;//need to look into it
    private EditText desc,rent,utilities,deposit;
    private CheckedTextView music,guests,drugs,latenights,washer,dryer,furnished,kitchen,closet,ac,heater,hasPet,internet,gym,pets,pool,wifi,smoking;
    private RadioButton checkbox;
    private ImageButton plusRooms,minusRooms,plusVacancy,minusVacancy;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_add_new_apartment, container, false);
        final Toolbar toolbar = (Toolbar)view.findViewById(R.id.toolbar);
        apartment = new UserApartment();
        ((AppCompatActivity)getActivity()).setSupportActionBar(toolbar);
        if(((AppCompatActivity) getActivity()).getSupportActionBar()!=null) {
            ((AppCompatActivity) getActivity()).                                                    getSupportActionBar().setTitle("New Apartment");
        ...
        if(bundle!= null){
            ...
            lat = address.getLat();lon = address.getLon();
        ...
        gym = (CheckedTextView) view.findViewById(R.id.checkBox_gym);//not found
        ...
        movin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                newFragment.setCallbackAddApt(AddAptFragment.this);
        ...
        occupant = (Switch) view.findViewById(R.id.roomieSwitch);
        ...
        genderM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(genderM.isChecked()){
                    genderM.setTextColor(getResources().getColor(R.color.colorPrimaryDark));
    ...
    public void onAttach(Context context) {
        ...
        try {
            onApartmentAddedListener = (OnApartmentAddedListener) context;
    ...
    private void uploadApartmentDetails() throws JSONException {
       ...
       // Map<String, String> params = new HashMap<String, String>();
        ...
        // params.put("laundry", Boolean.toString(apartment.isLaundry()));
...
//        params.put("occupant",Boolean.toString(apartment.isOccupant()));
        ...
        Log.i("AddAptFragemnt: ",params.toString());

        JsonObjectRequest strReq = new JsonObjectRequest(Request.Method.POST,
                AppConfig.URL_ADD_APT,params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (jObj.has("id")) {
                        ...
                        long aiid = db.addApartment(jObj,user.get("row_id"));

                        Log.d(TAG,imageUrl);
                        onApartmentAddedListener.setApartmentId(apartmentID,user.get("token"),aiid);
//                        AddAptImagesFragment nextFrag= new AddAptImagesFragment();
//                        getActivity().getSupportFragmentManager().beginTransaction()
//                                .replace(R.id.flContent, nextFrag)
//                                .addToBackStack(null)
//                                .commit();
