 ...
 */
public class UpdateAptImagesSlideshowFragment extends android.support.v4.app.DialogFragment{
    private String TAG = UpdateAptImagesSlideshowFragment.class.getSimpleName();
    ...
    public static UpdateAptImagesSlideshowFragment newInstance() {
        UpdateAptImagesSlideshowFragment f = new UpdateAptImagesSlideshowFragment();
        return f;
    }
