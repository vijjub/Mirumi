...
import com.dbxlab.vijjub.mirumy.fragments.addapartment.MapsActivity;
...
public class UpdateAddressFragment extends Fragment {
    ...
    public UserApartment apartment;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_apartment_address, container, false);
        ...
        completeAddress.setText(apartment.getAddress());
        ...
        addressNotFound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle1.putSerializable("userApartment",apartment);
                UpdateAddressFormFragment nextFrag= UpdateAddressFormFragment.newInstance(bundle1);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem){
        ...
        switch (menuItem.getItemId()){
            case R.id.done:
                ...
                if(result==true){
                    apartment.setAddress(address.getFullAddress());
                    apartment.setLat(address.getLat());
                    apartment.setLon(address.getLon());
    ...
    private boolean checkAddress() {
        ...
        return address.getFullAddress() != null || completeAddress.getText().toString() != null;
    }
